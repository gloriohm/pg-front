	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					'border-border bg-primary-foreground hover:bg-muted hover:text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground shadow-xs',
				secondary:
				...
				link: 'border-border bg-amber-200 text-primary hover:bg-muted hover:text-foreground'
			},
			size: {
				default:
