...
<article class="px-1">
	<div class="mb-2">
      <NavGroup links={data.home.links} />
    </div>
	<div class="mb-4">
	...
	<div>
		<h2 class={H2}>Norges billigste øl</h2>
		<BarList bars={data.home.top_ten_bars} />
		<h2 class={H2}>Norges dyreste øl</h2>
		<BarList bars={data.home.bottom_ten_bars} />
	</div>
</article>
